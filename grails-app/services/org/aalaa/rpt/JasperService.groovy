    ...
    private Collection getReportData(testModel, parameters) {
        ...
        if (testModel?.data) {
            try {
                ...
                throw new Exception("Expected chainModel.data parameter to be a Collection, but it was ${chainModel.data.class.title}", e)
            }
        } else {
            ...
            if (testModel?.data) {
                try {
                    ...
                    throw new Exception("Expected model.data parameter to be a Collection, but it was ${model.data.class.title}", e)
                }
            } else if (parameters?.data) {
                try {
                    reportData = parameters.data
                } catch (Throwable e) {
                    throw new Exception("Expected data parameter to be a Collection, but it was ${parameters.data.class.title}", e)
                }
            }
        }
