        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    <g:form url="[resource: admBranchInstance, action: 'update']" method="PUT" ><!-- enctype="multipart/form-data">-->
                        <div class="box-body">
                            <g:hiddenField name="id" value="${admBranchInstance?.id}"/>
                            <g:hiddenField name="version" value="${admBranchInstance?.version}"/>
                            <g:render template="form" model="${[admBranchInstance:admBranchInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                %{--<sec:access url="/admBranch/show/${admBranchInstance?.id}">--}%
                                    %{--<g:link class="btn btn-warning pull-right" action="show" id="${admBranchInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>--}%
                                %{--</sec:access>--}%
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
