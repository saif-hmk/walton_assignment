...
<div class="content-wrapper">
    <section class="content-header"><!-- Content Header (Page header) -->
        ...
        <ul class="top-links">
            <sec:access url="/nmMessageContent/index">
                <li>
                    <g:link class="btn btn-xs btn-block btn-vimeo" action="myDesk">
                        <i class="fa fa-reorder"></i> <g:message code="default.button.myDesk" default="My Desk"/>
                    </g:link>
                </li>
            </sec:access>
    ...
    <section class="content"><!-- Main content -->
        ...
        <div class="box box-info search-content"><!--Search Content-->
            <g:form url="[resource: nmMessageContentInstance, action: 'index']" method="POST">
                <div class="box-body">
                    ...
                    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
                        <div class='form-group'>
                            <label><g:message code="label.nmMessageContent.category" default="Category"/></label>
                            <g:select name="category" class="form-control many-to-one" from="${org.aalaa.com.ComLookup.list().sort { it.id }}" value="${nmMessageContentInstance?.category?.id}" optionKey="id" noSelection="['': 'Select One']"/>
                        </div>
                    </div>

                    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
                        <div class='form-group'>
                            <label><g:message code="label.nmMessageContent.recipient" default="Recipient"/></label>
                            <g:select name="recipient" class="form-control many-to-one" from="${org.aalaa.auth.AuthUser.list().sort { it.id }}" value="${nmMessageContentInstance?.recipient?.id}" optionKey="id" noSelection="['': 'Select One']"/>
                        </div>
                    </div>
