        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    <g:form url="[resource: locCountryInstance, action: 'update']" method="PUT" ><!-- enctype="multipart/form-data">-->
                        <div class="box-body">
                            <g:hiddenField name="id" value="${locCountryInstance?.id}"/>
                            <g:hiddenField name="version" value="${locCountryInstance?.version}"/>
                            <g:render template="form" model="${[locCountryInstance:locCountryInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                %{--<sec:access url="/locCountry/show/${locCountryInstance?.id}">--}%
                                    %{--<g:link class="btn btn-warning pull-right" action="show" id="${locCountryInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>--}%
                                %{--</sec:access>--}%
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
