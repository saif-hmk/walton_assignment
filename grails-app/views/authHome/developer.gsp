...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'dashboard.developer.pageTitle', default: 'Dashboard - Developer')}"/>
...
%{--<script type="text/javascript" src="${resource(dir: "resources/plugins/chartJs/3.6.2", file: "chart.min.js")}"></script>--}%
