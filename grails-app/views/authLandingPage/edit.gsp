            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    <g:form url="[resource: authLandingPageInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="id" value="${authLandingPageInstance?.id}" />
                        ...
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                %{--<sec:access url="/authLandingPage/show/${authLandingPageInstance?.id}">--}%
                                    %{--<g:link class="btn btn-warning pull-right" action="show" id="${authLandingPageInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack", default: "Go Back")}</g:link>--}%
                                %{--</sec:access>--}%
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
