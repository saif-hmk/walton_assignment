...
<div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
    ...
    <section class="content"><!-- Main content -->
        <div class="box box-primary">
            <g:form url="[resource: authMenuInstance, action: 'update']" method="PUT"><!-- enctype="multipart/form-data">-->
                <div class="box-body">
                    <g:hiddenField name="id" value="${authMenuInstance?.id}"/>
                    ...
                    <g:render template="formChildMenu" model="${[authMenuInstance: authMenuInstance, childMenuList: authMenuInstance?.childMenu?.sort{it.sortOrder}]}"/>
                </div><!-- /.box-body -->
