        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    <g:form url="[resource: admVendorOrganizationInstance, action: 'update']" method="PUT" ><!-- enctype="multipart/form-data">-->
                        <div class="box-body">
                            <g:hiddenField name="id" value="${admVendorOrganizationInstance?.id}"/>
                            <g:hiddenField name="version" value="${admVendorOrganizationInstance?.version}"/>
                            <g:render template="form" model="${[admVendorOrganizationInstance:admVendorOrganizationInstance]}"/>
                            <g:render template="formComBranch" model="${[admBranchList : admVendorOrganizationInstance?.admBranch]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                %{--<sec:access url="/admVendorOrganization/show/${admVendorOrganizationInstance?.id}">--}%
                                    %{--<g:link class="btn btn-warning pull-right" action="show" id="${admVendorOrganizationInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>--}%
                                %{--</sec:access>--}%
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
