 ...
 * <p>
 * It contains the location of the report design file (title and folder) and
...
class JasperReportDef implements Serializable {
  ...
  /**
   * The title of the report file without extension.
   * <p>
   ...
   * <p>
   * This is an implementation of {@link net.sf.jasperreports.engine.JRDataSource}.
   */
   ...
   * @throws java.lang.Exception , report file not found
   */
  Resource getReport() {
