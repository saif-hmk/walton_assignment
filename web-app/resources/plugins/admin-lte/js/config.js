...
(function ($, AdminLTE) {
    ...
    demo_settings.append(
        ...
        "       Layout" +
        "   </label>" +
        "   <select class='form-control data-layout'>" +
        "       <option value='layout-fluid'>Fluid</option>" +
        //"       <option value='layout-fixed'>Fixed</option>" +
        ...
        //"<div class='form-group'>" +
        //"   <label class='control-sidebar-subheading'>" +
        //"       <input type='checkbox' class='pull-right' data-layout='sidebar-collapse'/> " +
        //"       Toggle Sidebar" +
        //"   </label>" +
    ...
    skins_list.append(skin_blue).append(skin_black).append(skin_purple).append(skin_green).append(skin_red).append(skin_yellow).append(skin_blue_light).append(skin_black_light).append(skin_purple_light).append(skin_green_light).append(skin_red_light).append(skin_yellow_light);
    demo_settings.append("<h4 class='control-sidebar-heading'>Skins</h4>").append(skins_list);
